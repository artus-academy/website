...
export default function FAQSection({ className }: { className?: string }) {
  return (
    <section
      id="faq"
      className={cn(
        "container mx-auto max-w-4xl px-4 py-12 md:py-16",
        className
      )}
    >
      {/* Header Animation */}
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="format">
            ...
            <AccordionContent className="text-muted-foreground">
              ...
              campus or join interactive online classes. You can switch anytime.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="emi">
            ...
            <AccordionContent className="text-muted-foreground">
              Definitely, we offer flexible EMI options for all students. Reach
              out to our counsellor for more details.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </motion.div>
