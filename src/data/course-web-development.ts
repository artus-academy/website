...
export const webDevelopment: Course = {
  ...
  description:
    "Learn to build complete web applications from scratch using HTML, CSS, JavaScript, React, Java, Spring Boot, and MySQL. Get hands-on with real projects, version control, and modern deployment workflows. Along with mock interviews and placement support.",
  overview: [
